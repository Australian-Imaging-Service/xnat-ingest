...
class Forms:
    ...
    def title(cls, title: str, ref: ft.Ref = None):
        ...
        txt_title = ft.Text(
            title, size=title_size, weight=ft.FontWeight.W_600, color=title_color
        )
    ...
    def left_aligned_row(cls, controls: list[ft.Control], ref: ft.Ref = None):
        return ft.Row(
            controls=controls, alignment=ft.MainAxisAlignment.START, ref=ref, col=12
        )

    @classmethod
    def center_aligned_row(cls, controls: list[ft.Control], ref: ft.Ref = None):
        return ft.Row(
            controls=controls, alignment=ft.MainAxisAlignment.CENTER, ref=ref, col=12
        )

    @classmethod
    def right_aligned_row(cls, controls: list[ft.Control], ref: ft.Ref = None):
        return ft.Row(
            controls=controls, alignment=ft.MainAxisAlignment.END, ref=ref, col=12
        )

    @classmethod
    def new_button(cls, call_on_click: Callable, ref: ft.Ref = None):
        return cls._button(
            ref=ref, text="New", icon=ft.icons.CREATE, call_on_click=call_on_click
        )

    @classmethod
    def edit_button(
        cls, call_on_click: Callable, disabled: bool = True, ref: ft.Ref = None
    ):
        btn = cls._button(
            ref=ref,
            text="Edit",
    ...
    def save_button(cls, call_on_click: Callable, ref: ft.Ref = None):
        return cls._button(
            ref=ref, text="Save", icon=ft.icons.SAVE, call_on_click=call_on_click
        )

    @classmethod
    def cancel_button(cls, call_on_click: Callable, ref: ft.Ref = None):
        return cls._button(
            ref=ref, text="Cancel", icon=ft.icons.CANCEL, call_on_click=call_on_click
        )
    ...
    def delete_button(
        ...
        btn = cls._button(
            ref=ref, text="Delete", icon=ft.icons.DELETE, call_on_click=call_on_click
        )
        btn.disabled = disabled
    ...
    def data_table(
        ...
        columns: dict,
        data: list,
        call_on_select_changed: Callable,
        ref: ft.Ref = None,
    ):
        ...
        return (
            ft.ResponsiveRow(
                controls=[ft.Card(content=table, col=12)],
                col=12,
            ...
            controls=[
                ft.Card(
                    content=ft.Container(
                        content=ft.Column(controls=form_rows), margin=12
                    )
                )
            ],
            col=12,
    ...
    def _button(cls, text: str, icon: str, call_on_click: Callable, ref: ft.Ref = None):
        return ft.ElevatedButton(
            ref=ref, text=text, icon=icon, on_click=call_on_click, width=140
        )
